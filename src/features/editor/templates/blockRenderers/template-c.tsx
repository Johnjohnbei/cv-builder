...
import { renderPhoto, renderContactInfo, isKPIInRange, CompanyTags, getSlicedBullets, getEducationLines } from '../TemplateParts';
...
import { getSectionTitle, getSkillCategoryTitle } from '../../lib/ats-rules';
