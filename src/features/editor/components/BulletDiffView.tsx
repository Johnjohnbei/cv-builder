  ...
  return (
    <div className="p-2 bg-amber-50 border border-amber-200 rounded mt-1 space-y-1">
      ...
      <div className="flex items-center gap-2 pt-1">
        <button
          onClick={onAccept}
          className="text-[11px] font-mono px-2 py-0.5 rounded bg-green-100 text-green-700 hover:bg-green-200 transition-colors"
        ...
        <button
          onClick={onReject}
          className="text-[11px] font-mono px-2 py-0.5 rounded bg-gray-100 text-gray-600 hover:bg-gray-200 transition-colors"
