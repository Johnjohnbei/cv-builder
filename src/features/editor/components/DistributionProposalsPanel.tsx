    ...
    >
      <div className="flex items-center justify-between">
        ...
        <div className="flex gap-1">
          <button
            onClick={onAcceptAll}
            className="text-[11px] font-mono px-2 py-0.5 rounded bg-green-100 text-green-700 hover:bg-green-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-green-500"
          ...
          <button
            onClick={onRejectAll}
            className="text-[11px] font-mono px-2 py-0.5 rounded bg-gray-100 text-gray-600 hover:bg-gray-200 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-gray-400"
  ...
  return (
    <li className="p-2 bg-amber-50 border border-amber-200 rounded space-y-1">
      <div className="flex items-center justify-between gap-1">
        <span className="text-[11px] font-semibold text-amber-900 bg-amber-100 px-1.5 py-0.5 rounded">
          {p.keyword}
        </span>
        <span
      ...
      {p.originalBullet && (
        <p className="text-[11px] text-red-600 line-through">{p.originalBullet}</p>
      )}
      {p.rewrittenBullet && (
        <p className="text-[11px] text-green-700 font-medium">{p.rewrittenBullet}</p>
      )}
      ...
      <div className="flex items-center gap-2 pt-1">
        <button
          onClick={onAccept}
          disabled={!canAccept}
          className="text-[11px] font-mono px-2 py-0.5 rounded bg-green-100 text-green-700 hover:bg-green-200 disabled:opacity-40 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-green-500"
