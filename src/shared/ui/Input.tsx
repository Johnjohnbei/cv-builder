...
const defaultVariantBase =
  'border border-[var(--border-color)] rounded bg-white focus:outline-none focus:border-[var(--google-blue)] focus:ring-1 focus:ring-[var(--google-blue)] placeholder:text-gray-500';
...
const bareVariantBase =
  ...
  'placeholder:text-gray-500 placeholder:italic transition-colors';
