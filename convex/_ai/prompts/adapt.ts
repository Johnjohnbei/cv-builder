...
2. Une exigence n'est écrite que si le CV source la prouve (une expérience, une compétence ou une formation qui la démontre). Écris alors le libellé exact de l'offre à l'endroit qui porte la preuve : une puce de l'expérience concernée, le résumé ou les compétences.
3. Une exigence sans preuve dans le CV source n'est écrite nulle part : c'est un écart que le candidat verra.
...
Une entrée "evidence" par exigence écrite dans le CV, aucune pour une exigence sans preuve.
